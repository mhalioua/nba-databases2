class IndexController < ApplicationController
	...
	def detail
		...
		@away_players_group1 = []
		@away_players_group2 = []
		@away_players_group3 = @away_last.players.where("team_abbr = ?", @away_flag).order(:state)
		...
		@home_players_group1 = []
		@home_players_group2 = []
		@home_players_group3 = @home_last.players.where("team_abbr = ?", @home_flag).order(:state)
