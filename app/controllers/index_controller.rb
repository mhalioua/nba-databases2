class IndexController < ApplicationController
	...
	def detail
		...
		@home_injury = Injury.where("team = ? AND date >= ?", @game.home_team, (Time.now - 5.hours))
		@away_injury = Injury.where("team = ? AND date >= ?", @game.away_team,  (Time.now - 5.hours))
		...
		@home_injuries = Injury.where("team = ? AND date >= ?", @game.home_team,  (Time.now - 5.hours))
		@away_injuries = Injury.where("team = ? AND date >= ?", @game.away_team,  (Time.now - 5.hours))
	end
