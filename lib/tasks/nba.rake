		...
		puts url
	  	...
	  	elements.each do |slice|
			...
			puts url
	  		...
	  		game.update(away_team: away_team, home_team: home_team, home_abbr: home_abbr, away_abbr: away_abbr, game_date: game_date, year: date.strftime("%Y"), date: date.strftime("%b %e"))
	  	end
	end
