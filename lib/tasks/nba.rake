namespace :nba do
  ...
  task :teaminfo => :environment do
    include Api
    url = "http://www.espn.com/nba/standings/_/season/2008/sort/wins/group/league"
    doc = download_document(url)
    ...
    elements.each_with_index do |element, index|
      ...
      team.update(order_one_seven: index + 1)
    end

    url = "http://www.espn.com/nba/standings/_/season/2008/sort/avgpointsfor/group/league"
    doc = download_document(url)
    elements = doc.css("abbr")
    puts elements.length
    elements.each_with_index do |element, index|
      ...
      team.update(order_two_seven: index + 1)
    end

    url = "http://www.espn.com/nba/standings/_/season/2008/sort/avgpointsagainst/group/league"
    doc = download_document(url)
    elements = doc.css("abbr")
    puts elements.length
    elements.each_with_index do |element, index|
      ...
      team.update(order_thr_seven: index + 1)
    end
  end
